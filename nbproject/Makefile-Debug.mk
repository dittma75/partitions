...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/partitions_generating_working_copy.exe: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/partitions_generating_working_copy ${OBJECTFILES} ${LDLIBSOPTIONS} -lgmp

${OBJECTDIR}/distinct.o: distinct.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distinct.o distinct.c

${OBJECTDIR}/h_function_generator.o: h_function_generator.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/h_function_generator.o h_function_generator.c

${OBJECTDIR}/h_sign_generator.o: h_sign_generator.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/h_sign_generator.o h_sign_generator.c

${OBJECTDIR}/least_part_m.o: least_part_m.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/least_part_m.o least_part_m.c
...
${OBJECTDIR}/parts_less_than_equal_to_m.o: parts_less_than_equal_to_m.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parts_less_than_equal_to_m.o parts_less_than_equal_to_m.c

${OBJECTDIR}/unrestricted_partition.o: unrestricted_partition.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/unrestricted_partition.o unrestricted_partition.c
